...
FROM (
  ...
  UNION ALL SELECT 'MENU_ADMIN_USER_GROUP_PERMISSION', 'MENU_ITEM', 'MENU', 'admin/user-group-permission', 'Access Admin User Group Permission', 'Shows the Admin User Group Permission menu item.'
  UNION ALL SELECT 'MENU_ADMIN_USER_GROUP_MEMBERSHIP', 'MENU_ITEM', 'MENU', 'admin/user-group-membership', 'Access Admin User Group Membership', 'Shows the Admin User Group Membership menu item.'
  ...
  UNION ALL SELECT 'GROUP_PERMISSION_READ', 'GROUP_PERMISSION', 'READ', '*', 'Read Group Permissions', 'Allows viewing permissions assigned to a user group.'
  ...
  UNION ALL SELECT 'GROUP_MEMBERSHIP_READ', 'GROUP_MEMBERSHIP', 'READ', '*', 'Read Group Memberships', 'Allows viewing users assigned to a user group.'
