...
FROM (
  ...
  UNION ALL SELECT 'OwnerAdmin', 'MENU_ADMIN_USER_GROUP_PERMISSION'
  UNION ALL SELECT 'OwnerAdmin', 'MENU_ADMIN_USER_GROUP_MEMBERSHIP'
  UNION ALL SELECT 'OwnerAdmin', 'MENU_ADMIN_SYSTEM_CODE'
  UNION ALL SELECT 'OwnerAdmin', 'MENU_ADMIN_SYSTEM_PROPERTY'
  ...
  UNION ALL SELECT 'OwnerAdmin', 'SYSTEM_PROPERTY_READ'
  UNION ALL SELECT 'OwnerAdmin', 'SYSTEM_PROPERTY_WRITE'
  UNION ALL SELECT 'OwnerAdmin', 'SYSTEM_PROPERTY_APPROVE'
  UNION ALL SELECT 'OwnerAdmin', 'USER_GROUP_READ'
  UNION ALL SELECT 'OwnerAdmin', 'GROUP_PERMISSION_READ'
  UNION ALL SELECT 'OwnerAdmin', 'GROUP_PERMISSION_WRITE'
  UNION ALL SELECT 'OwnerAdmin', 'GROUP_PERMISSION_APPROVE'
  UNION ALL SELECT 'OwnerAdmin', 'GROUP_MEMBERSHIP_READ'
  UNION ALL SELECT 'OwnerAdmin', 'GROUP_MEMBERSHIP_WRITE'
  UNION ALL SELECT 'OwnerAdmin', 'GROUP_MEMBERSHIP_APPROVE'
  ...
  UNION ALL SELECT 'UserGroupMaker', 'MENU_ADMIN_USER_GROUP_PERMISSION'
  UNION ALL SELECT 'UserGroupMaker', 'MENU_ADMIN_USER_GROUP_MEMBERSHIP'
  UNION ALL SELECT 'UserGroupMaker', 'USER_GROUP_READ'
  UNION ALL SELECT 'UserGroupMaker', 'USER_GROUP_WRITE'
  UNION ALL SELECT 'UserGroupMaker', 'GROUP_PERMISSION_READ'
  UNION ALL SELECT 'UserGroupMaker', 'GROUP_PERMISSION_WRITE'
  UNION ALL SELECT 'UserGroupMaker', 'GROUP_MEMBERSHIP_READ'
  UNION ALL SELECT 'UserGroupMaker', 'GROUP_MEMBERSHIP_WRITE'

  UNION ALL SELECT 'UserGroupChecker', 'MENU_ADMIN_USER_GROUP'
  UNION ALL SELECT 'UserGroupChecker', 'MENU_ADMIN_USER_GROUP_PERMISSION'
  UNION ALL SELECT 'UserGroupChecker', 'MENU_ADMIN_USER_GROUP_MEMBERSHIP'
  UNION ALL SELECT 'UserGroupChecker', 'USER_GROUP_READ'
  UNION ALL SELECT 'UserGroupChecker', 'USER_GROUP_APPROVE'
  UNION ALL SELECT 'UserGroupChecker', 'GROUP_PERMISSION_READ'
  UNION ALL SELECT 'UserGroupChecker', 'GROUP_PERMISSION_APPROVE'
  UNION ALL SELECT 'UserGroupChecker', 'GROUP_MEMBERSHIP_READ'
  UNION ALL SELECT 'UserGroupChecker', 'GROUP_MEMBERSHIP_APPROVE'
